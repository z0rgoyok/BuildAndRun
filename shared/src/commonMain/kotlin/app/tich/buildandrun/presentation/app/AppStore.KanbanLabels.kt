...
internal fun resolveStatusToPushText(commits: String): String =
    resolveText(text = UiText(resource = Res.string.detail_to_push, args = listOf(commits)))

internal fun resolveStatusBehindText(commits: String): String =
    resolveText(text = UiText(resource = Res.string.detail_behind, args = listOf(commits)))

internal fun resolveNewTaskInText(column: String): String =
    resolveText(text = UiText(resource = Res.string.detail_new_task_in, args = listOf(column)))
