...
internal fun AppWiring.onAddTask(
    title: String,
    description: String?,
...
internal fun AppWiring.onMoveTask(
    taskId: String,
    column: KanbanColumnType,
) {
    val scope = currentKanbanScope() ?: return
...
internal fun AppWiring.onUpdateTask(
    taskId: String,
    title: String,
    description: String?,
) {
...
internal fun AppWiring.onDeleteTask(taskId: String) {
    val scope = currentKanbanScope() ?: return
...
private fun AppWiring.currentKanbanScope(): KanbanScope? {
...
private fun AppWiring.persistKanbanTasks(
    scope: KanbanScope,
...
private fun AppWiring.normalizedTaskTitleOrPublishError(title: String): String? {
