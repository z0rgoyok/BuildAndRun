...
internal fun AppWiring.onAddRepositoryPathChanged(value: String) {
    repositoriesState.addRepositoryPathInput = value
    clearMessages()
    publishState()
}

internal fun AppWiring.onAddRepository() {
...
internal fun AppWiring.onSelectRepository(repositoryId: String) {
...
internal fun AppWiring.onArchiveRepository(repositoryId: String) {
...
internal fun AppWiring.onRestoreRepository(repositoryId: String) {
    onSetRepositoryArchivedState(
        repositoryId = repositoryId,
        isArchived = false,
    )
...
internal fun AppWiring.onRemoveRepository(repositoryId: String) {
    if (activityCenter.isGlobalActive) {
        return
    }
    scope.launch {
...
internal fun AppWiring.onSetRepositoryArchivedState(
    repositoryId: String,
    isArchived: Boolean,
) {
    if (activityCenter.isGlobalActive) {
