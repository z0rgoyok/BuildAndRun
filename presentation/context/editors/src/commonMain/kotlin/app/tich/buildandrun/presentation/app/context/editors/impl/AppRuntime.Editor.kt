...
internal fun AppWiring.onSetRememberEditorChoice(value: Boolean) {
...
internal fun AppWiring.onSetEditorEnabled(
    editorId: String,
    enabled: Boolean,
) {
...
internal fun AppWiring.onSetPreferredEditor(editorId: String?) {
...
internal fun AppWiring.onOpenInEditor(
    worktreePath: String,
    editorId: String?,
) {
...
internal fun AppWiring.onOpenInFinder(worktreePath: String) {
    val normalizedWorktreePath = normalizePath(worktreePath)
    if (normalizedWorktreePath.isBlank()) {
        return
    }
...
internal fun AppWiring.onOpenInTerminal(worktreePath: String) {
    val normalizedWorktreePath = normalizePath(worktreePath)
    if (normalizedWorktreePath.isBlank()) {
        return
    }
...
private fun AppWiring.resolveEditor(
    editorId: String?,
    repositoryId: String?,
): Editor? {
