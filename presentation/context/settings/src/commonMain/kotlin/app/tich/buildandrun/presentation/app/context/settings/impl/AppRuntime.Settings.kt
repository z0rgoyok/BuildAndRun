...
internal fun AppWiring.onLoadBranches() {
...
internal fun AppWiring.branchExists(branch: String): Boolean {
...
internal fun AppWiring.onSetWorktreeBasePath(path: String) {
...
internal fun AppWiring.preferredBaseBranch(): String? {
...
internal fun AppWiring.onSetPreferredBaseBranch(branch: String) {
...
internal fun AppWiring.onSetDefaultCopyPatterns(patterns: List<String>) {
...
internal fun AppWiring.onSetRepositoryCopyPatterns(patterns: List<String>?) {
    val repository = selectedRepository() ?: return
    if (patterns == null) {
