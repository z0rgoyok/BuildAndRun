...
internal fun AppWiring.onPush(worktreePath: String) {
...
internal fun AppWiring.onPull(worktreePath: String) {
    val pair = findWorktreeByPath(path = worktreePath) ?: return
    scope.launch {
...
internal fun AppWiring.onCreatePullRequest(
    worktreePath: String,
    title: String,
    body: String,
    baseBranch: String?,
...
internal fun AppWiring.onOpenPullRequest(worktreePath: String) {
    val pair = findWorktreeByPath(path = worktreePath) ?: return
    scope.launch {
        runCatching {
            val status = graph.gitClient.getWorktreeStatus(atWorktreePath = pair.second.path)
...
internal fun AppWiring.onLockWorktree(worktreePath: String) {
    val pair = findWorktreeByPath(path = worktreePath) ?: return
    scope.launch {
...
internal fun AppWiring.onUnlockWorktree(worktreePath: String) {
    val pair = findWorktreeByPath(path = worktreePath) ?: return
    scope.launch {
...
internal fun AppWiring.onRemoveWorktree(
    worktreePath: String,
    force: Boolean,
...
internal fun AppWiring.onCompleteWorktree(
    worktreePath: String,
    targetBranch: String,
...
internal fun AppWiring.onLoadHasRemoteBranch(worktreePath: String) {
    val pair = findWorktreeByPath(path = worktreePath) ?: return
    scope.launch {
        runCatching {
...
internal fun AppWiring.onPruneWorktrees() {
